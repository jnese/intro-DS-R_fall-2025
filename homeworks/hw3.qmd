...
1.  Load the `{tidyverse}`, `{ggridges}`, and `{ISLR}` packages in the first chunk. (Install any if needed.)

2.  Run the following lines of code to read about and view the data we'll use for this lab.

-   Comment out lines 31 and 32 after you run it, but putting a `#` at the start of the line.
